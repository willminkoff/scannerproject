...
<dict>
  ...
  <array>
    ...
    <string>$SCANNER_REPO_ROOT/scripts/run_mcp_slack_notify.sh</string>
  </array>
  <key>RunAtLoad</key>
  <true/>
  <key>KeepAlive</key>
  ...
  <string>$SCANNER_REPO_ROOT</string>
  <key>StandardOutPath</key>
...
<dict>
  ...
  <array>
    <string>/bin/zsh</string>
    <string>$DILLARD_REPO_ROOT/scripts/run_mcp_slack_notify.sh</string>
  </array>
  <key>RunAtLoad</key>
  <true/>
  <key>KeepAlive</key>
  ...
  <integer>10</integer>
  <key>WorkingDirectory</key>
  <string>$DILLARD_REPO_ROOT</string>
  <key>StandardOutPath</key>
