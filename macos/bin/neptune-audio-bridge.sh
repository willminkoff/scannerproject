...
# (no Homebrew needed for it), and the mount is neptune-angel.mp3. Restarts ffmpeg if it
...
while true; do
  "$FFMPEG" -hide_banner -loglevel warning \
    ...
    "icecast://source:${ICECAST_SOURCE_PASSWORD}@127.0.0.1:8000/neptune-angel.mp3"
