...
# Vendored from github.com/madengr/ham2mon @ db9834c (apps/receiver.py).
# GR 3.7 -> GR 3.10 port:
#   1) Ran 2to3 (print-as-function).
#   2) Renamed grfilter.firdes_low_pass(...) -> grfilter.firdes.low_pass(...) 6 sites.
#   3) Renamed grfilter.firdes.WIN_HAMMING -> window.WIN_HAMMING 6 sites.
# `from gnuradio.fft import window` was already present in the ham2mon original.
