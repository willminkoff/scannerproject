import Ie from"https://esm.sh/react@18";import{createRoot as ca}from"https://esm.sh/react-dom@18/client";import ie from"https://esm.sh/react@18";import Lt,{createContext as Mt,useCallback as H,useContext as Ot,useEffect as ue,useMemo as Pt,useRef as Dt,useReducer as Ht}from"https://esm.sh/react@18";var Ct={"Content-Type":"application/json"};async function z(e,{method:t="GET",body:a}={}){let n={method:t,headers:{...Ct}};a!==void 0&&(n.body=JSON.stringify(a));let s=await fetch(e,n),i=await s.text(),r={};try{r=i?JSON.parse(i):{}}catch{r={raw:i}}if(!s.ok){let u=r?.error||`Request failed (${s.status})`,f=new Error(u);throw f.status=s.status,f.payload=r,f}return r}function de(){return z("/api/hp/state")}function We(e){return z("/api/hp/state",{method:"POST",body:e})}function pe(){return z("/api/hp/service-types")}function ce(){return z("/api/hp/avoids")}function qe(){return z("/api/hp/avoids",{method:"POST",body:{action:"clear"}})}function Ye(e){return z("/api/hp/avoids",{method:"POST",body:{action:"remove",system:e}})}function Ke(){return z("/api/status")}function Ze(e){return z("/api/mode",{method:"POST",body:{mode:e}})}function Je(e={}){return z("/api/hp/hold",{method:"POST",body:e})}function Xe(e={}){return z("/api/hp/next",{method:"POST",body:e})}function Qe(e={}){return z("/api/hp/avoid",{method:"POST",body:e})}function hpSyncStatus(){return z("/api/hp/favorites-sync")}function hpSyncApply(e={}){return z("/api/hp/favorites-sync",{method:"POST",body:{action:"sync",...(e||{})}})}var p=Object.freeze({MAIN:"MAIN",MENU:"MENU",LOCATION:"LOCATION",SERVICE_TYPES:"SERVICE_TYPES",RANGE:"RANGE",FAVORITES:"FAVORITES",AVOID:"AVOID",MODE_SELECTION:"MODE_SELECTION"}),Ft={hpState:{},serviceTypes:[],liveStatus:{},hpAvoids:[],currentScreen:p.MAIN,mode:"expert",sseConnected:!1,loading:!0,working:!1,error:"",message:""},Bt=["digital_scheduler_active_system","digital_scheduler_active_system_label","digital_scheduler_next_system","digital_scheduler_next_system_label","digital_scheduler_active_department_label","digital_last_label","digital_channel_label","digital_department_label","digital_system_label","digital_last_mode","digital_last_tgid","digital_profile","digital_scan_mode","stream_mount","digital_stream_mount","profile_airband","profile_ground","last_hit_airband_label","last_hit_ground_label"];function Re(e){return e==null?!1:typeof e=="string"?e.trim()!=="":Array.isArray(e)?e.length>0:!0}function ee(e){if(!Array.isArray(e))return[];let t=[],a=new Set;return e.forEach(n=>{let s=String(n||"").trim();!s||a.has(s)||(a.add(s),t.push(s))}),t}function zt(e,t){let a=t&&typeof t=="object"?t:{},n={...e||{},...a};return Bt.forEach(s=>{!Re(a[s])&&Re(e?.[s])&&(n[s]=e[s])}),n}function $t(e,t){switch(t.type){case"LOAD_START":return{...e,loading:!0,error:""};case"LOAD_SUCCESS":return{...e,loading:!1,error:"",hpState:t.payload.hpState||{},serviceTypes:t.payload.serviceTypes||[],liveStatus:t.payload.liveStatus||{},hpAvoids:t.payload.hpAvoids||[],mode:t.payload.mode||e.mode};case"LOAD_ERROR":return{...e,loading:!1,error:t.payload||"Load failed"};case"SET_WORKING":return{...e,working:!!t.payload};case"SET_ERROR":return{...e,error:t.payload||""};case"SET_MESSAGE":return{...e,message:t.payload||""};case"SET_HP_STATE":return{...e,hpState:t.payload||{}};case"SET_SERVICE_TYPES":return{...e,serviceTypes:t.payload||[]};case"SET_HP_AVOIDS":return{...e,hpAvoids:ee(t.payload)};case"SET_LIVE_STATUS":return{...e,liveStatus:zt(e.liveStatus,t.payload),hpAvoids:Array.isArray(t.payload?.hp_avoids)?ee(t.payload.hp_avoids):e.hpAvoids};case"SET_MODE":return{...e,mode:t.payload||e.mode};case"SET_SSE_CONNECTED":return{...e,sseConnected:!!t.payload};case"NAVIGATE":return{...e,currentScreen:t.payload||p.MAIN};default:return e}}var at=Mt(null);function et(e){return(Array.isArray(e?.service_types)?e.service_types:[]).map(a=>({service_tag:Number(a?.service_tag),name:String(a?.name||`Service ${a?.service_tag}`),enabled_by_default:!!a?.enabled_by_default}))}function tt(e){let t=e&&typeof e.state=="object"&&e.state!==null?e.state:{},a=String(e?.mode||"expert").toLowerCase();return{hpState:t,mode:a}}function rt({children:e}){let[t,a]=Ht($t,Ft),n=Dt(!1),s=H(c=>{a({type:"NAVIGATE",payload:c})},[]),i=H(async()=>{let c=await de(),o=tt(c);return a({type:"SET_HP_STATE",payload:o.hpState}),a({type:"SET_MODE",payload:o.mode}),o},[]),r=H(async()=>{let c=await pe(),o=et(c);return a({type:"SET_SERVICE_TYPES",payload:o}),o},[]),u=H(async()=>{let c=await ce(),o=ee(c?.avoids);return a({type:"SET_HP_AVOIDS",payload:o}),o},[]),f=H(async()=>{if(n.current)return null;n.current=!0;try{let c=await Ke();return a({type:"SET_LIVE_STATUS",payload:c||{}}),c}finally{n.current=!1}},[]),w=H(async()=>{a({type:"LOAD_START"});try{let[c,o,m]=await Promise.all([de(),pe(),ce()]),b=tt(c),l=et(o),_=ee(m?.avoids);a({type:"LOAD_SUCCESS",payload:{hpState:b.hpState,mode:b.mode,serviceTypes:l,liveStatus:{},hpAvoids:_}})}catch(c){a({type:"LOAD_ERROR",payload:c.message})}},[]);ue(()=>{w()},[w]),ue(()=>{let c=setInterval(()=>{f().catch(()=>{})},t.sseConnected?1e4:5e3);return()=>clearInterval(c)},[f,t.sseConnected]),ue(()=>{if(typeof EventSource>"u")return;let c=!1,o=null,m=null,b=()=>{c||(o=new EventSource("/api/stream"),o.onopen=()=>{a({type:"SET_SSE_CONNECTED",payload:!0})},o.addEventListener("status",l=>{try{let _=JSON.parse(l?.data||"{}");a({type:"SET_LIVE_STATUS",payload:_})}catch{}}),o.onerror=()=>{a({type:"SET_SSE_CONNECTED",payload:!1}),o&&(o.close(),o=null),c||(m=setTimeout(b,2e3))})};return b(),()=>{c=!0,a({type:"SET_SSE_CONNECTED",payload:!1}),m&&clearTimeout(m),o&&o.close()}},[]);let S=H(async c=>{a({type:"SET_WORKING",payload:!0}),a({type:"SET_ERROR",payload:""});try{let o=c&&typeof c=="object"?{...c}:{},m=await We(o),b=m?.state&&typeof m.state=="object"?{...t.hpState,...m.state}:{...t.hpState,...o};return a({type:"SET_HP_STATE",payload:b}),a({type:"SET_MESSAGE",payload:"State saved"}),m}catch(o){throw a({type:"SET_ERROR",payload:o.message}),o}finally{a({type:"SET_WORKING",payload:!1})}},[t.hpState]),L=H(async c=>{a({type:"SET_WORKING",payload:!0}),a({type:"SET_ERROR",payload:""});try{let o=await Ze(c),m=String(o?.mode||c||"hp").toLowerCase();let b0=m==="expert"?"SB3":m==="hp"?"HP3":m;return a({type:"SET_MODE",payload:m}),a({type:"SET_MESSAGE",payload:`Mode set to ${b0}`}),o}catch(o){throw a({type:"SET_ERROR",payload:o.message}),o}finally{a({type:"SET_WORKING",payload:!1})}},[]),y=H(async(c,o)=>{a({type:"SET_WORKING",payload:!0}),a({type:"SET_ERROR",payload:""});try{let m=await c();return Array.isArray(m?.avoids)&&a({type:"SET_HP_AVOIDS",payload:m.avoids}),o&&a({type:"SET_MESSAGE",payload:o}),await i(),await f(),m}catch(m){throw a({type:"SET_ERROR",payload:m.message}),m}finally{a({type:"SET_WORKING",payload:!1})}},[i,f]),N=H(async()=>y(()=>Je(),"Hold command sent"),[y]),k=H(async()=>y(()=>Xe(),"Next command sent"),[y]),h=H(async(c={})=>y(()=>Qe(c),"Avoid command sent"),[y]),g=H(async()=>y(()=>qe(),"Runtime avoids cleared"),[y]),T=H(async c=>y(()=>Ye(c),"Avoid removed"),[y]),B=H(async(c={})=>{a({type:"SET_WORKING",payload:!0}),a({type:"SET_ERROR",payload:""});try{let o=await hpSyncApply(c),m=o?.after&&typeof o.after=="object"?o.after:{};return a({type:"SET_LIVE_STATUS",payload:{hp_favorites_sync:m,hp_favorites_sync_ok:!!o?.ok,hp_favorites_sync_available:!!m?.available,hp_favorites_sync_in_sync:!!m?.in_sync,hp_favorites_sync_reason:String(m?.reason||""),hp_favorites_sync_profile_id:String(m?.active_profile_id||""),hp_favorites_sync_favorites_name:String(m?.favorites_name||""),hp_favorites_sync_missing_count:Number(m?.missing_in_profile_count||0),hp_favorites_sync_extra_enabled_count:Number(m?.extra_enabled_count||0)}}),await i(),await f(),o}catch(o){throw a({type:"SET_ERROR",payload:o.message}),o}finally{a({type:"SET_WORKING",payload:!1})}},[i,f]),C=Pt(()=>({state:t,dispatch:a,navigate:s,refreshAll:w,refreshHpState:i,refreshServiceTypes:r,refreshHpAvoids:u,refreshStatus:f,saveHpState:S,setMode:L,holdScan:N,nextScan:k,avoidCurrent:h,clearHpAvoids:g,removeHpAvoid:T,syncFavoritesToProfile:B,SCREENS:p}),[t,s,w,i,r,u,f,S,L,N,k,h,g,T,B]);return Lt.createElement(at.Provider,{value:C},e)}function P(){let e=Ot(at);if(!e)throw new Error("useUI must be used inside UIProvider");return e}import G from"https://esm.sh/react@18";import d,{useEffect as me,useMemo as it,useState as Y}from"https://esm.sh/react@18";import Ut from"https://esm.sh/react@18";function D({children:e,onClick:t,type:a="button",variant:n="primary",className:s="",disabled:i=!1}){return Ut.createElement("button",{type:a,className:`btn ${n==="secondary"?"btn-secondary":n==="danger"?"btn-danger":""} ${s}`.trim(),onClick:t,disabled:i},e)}var nt=["|","/","-","\\"],Gt=6e3;function F(e){return e==null||e===""?"--":String(e)}function Vt(e){let t=Number(e);return!Number.isFinite(t)||t<=0?0:t<1e10?t*1e3:t}function jt(e){let t=Math.max(0,Math.min(4,Number(e)||0));return`${"|".repeat(t)}${".".repeat(4-t)}`}function Wt(e){let t=Number(e);return Number.isFinite(t)?Number.isInteger(t)?`Range ${t}`:`Range ${t.toFixed(1)}`:"Range"}function qt(e,t){let a=t==="ground"?e?.profile_ground:e?.profile_airband,n=t==="ground"?e?.profiles_ground:e?.profiles_airband,s=Array.isArray(n)?n:[],i=String(a||"").trim();if(!i)return"";let r=s.find(f=>String(f?.id||"").trim().toLowerCase()===i.toLowerCase());return String(r?.label||"").trim()||i}function Yt(e,t){let a=String(t||"").trim(),n=String(e||"").trim();if(!n&&!a)return{system:"--",department:"--",channel:"--"};let s=[" | "," - "," / "," \u2014 "," \u2013 ","::"];for(let i of s){if(!n.includes(i))continue;let r=n.split(i).map(u=>String(u||"").trim()).filter(Boolean);if(r.length>=3)return{system:r[0],department:r[1],channel:r.slice(2).join(" / ")};if(r.length===2)return{system:a||r[0],department:r[0],channel:r[1]}}return{system:a||n||"--",department:n||a||"--",channel:n||"--"}}var hp3AudioControlEvent="hp3-audio-control",hp3AudioStateEvent="hp3-audio-state";function dispatchHp3AudioControl(e){document.dispatchEvent(new CustomEvent(hp3AudioControlEvent,{detail:e||{}}))}function readHp3AudioElement(){return document.getElementById("hp3-hidden-audio")}function SpeakerAudioDock(){let{state:e}=P(),{working:t,liveStatus:a}=e,n=String(a?.stream_mount||"ANALOG.mp3").trim().replace(/^\//,""),s=String(a?.digital_stream_mount||"DIGITAL.mp3").trim().replace(/^\//,""),i=!!n,r=!!s,[u,f]=Y((e.mode==="hp"||e.mode==="expert")&&r?"digital":"analog"),[w,S]=Y(!1),[L,y]=Y(!1),[N,k]=Y(.7),h=Math.round(Math.max(0,Math.min(1,N))*100),j=10,g=u==="analog",T=u==="digital";me(()=>{let C=o=>{let m=o?.detail&&typeof o.detail=="object"?o.detail:{};typeof m.source=="string"&&f(m.source),typeof m.muted=="boolean"&&y(m.muted)};return document.addEventListener(hp3AudioStateEvent,C),()=>document.removeEventListener(hp3AudioStateEvent,C)},[]),me(()=>{let C=setInterval(()=>{let o=readHp3AudioElement();o&&(S(!o.paused),y(!!o.muted),k(Number.isFinite(o.volume)?o.volume:N))},450);return()=>clearInterval(C)},[]),me(()=>{if(u==="digital"&&!r){let C=i?"analog":"digital";f(C),dispatchHp3AudioControl({action:"set-source",value:C});return}u==="analog"&&!i&&r&&(f("digital"),dispatchHp3AudioControl({action:"set-source",value:"digital"}))},[u,i,r]);let C=async()=>{let o=readHp3AudioElement();if(!o)return;if(o.paused){try{await o.play(),S(!0)}catch{S(!1)}}else o.pause(),S(!1)},c=o=>{let m=readHp3AudioElement();if(!m)return;let b=Math.max(0,Math.min(1,(Number(m.volume)||0)+o));m.volume=b,m.muted&&b>0&&(m.muted=!1,dispatchHp3AudioControl({action:"set-mute",value:!1})),k(b)},A=o=>{let m=readHp3AudioElement();if(!m)return;let b=Math.max(0,Math.min(1,o));m.volume=b,m.muted&&b>0&&(m.muted=!1,dispatchHp3AudioControl({action:"set-mute",value:!1})),k(b)},x=()=>{let o=readHp3AudioElement();if(!o)return;let m=!o.muted;o.muted=m,y(m),dispatchHp3AudioControl({action:"set-mute",value:m})};return d.createElement("div",{className:"speaker-audio-dock"},d.createElement("div",{className:"speaker-audio-title"},"AUDIO"),d.createElement("div",{className:"speaker-source-row"},d.createElement("button",{type:"button",className:`speaker-chip ${g?"active":""}`,onClick:()=>{f("analog"),dispatchHp3AudioControl({action:"set-source",value:"analog"})},disabled:!i||t},"ANA"),d.createElement("button",{type:"button",className:`speaker-chip ${T?"active":""}`,onClick:()=>{f("digital"),dispatchHp3AudioControl({action:"set-source",value:"digital"})},disabled:!r||t},"DIG")),d.createElement("button",{type:"button",className:"speaker-play-btn",onClick:C,disabled:t},w?"II":">"),d.createElement("div",{className:"speaker-volume-row"},d.createElement("button",{type:"button",className:"speaker-vol-btn",onClick:()=>c(-.05),disabled:t||N<=0},"-"),d.createElement("div",{className:"speaker-vol-bars"},Array.from({length:j},(o,m)=>{let b=(m+1)*(100/j),l=(m+1)/j;return d.createElement("button",{key:m,type:"button",className:"speaker-vol-bar "+(h>=b?"on":""),onClick:()=>A(l),disabled:t,title:"Set volume "+Math.round(l*100)+"%","aria-label":"Set volume "+Math.round(l*100)+" percent"})})),d.createElement("button",{type:"button",className:"speaker-vol-btn",onClick:()=>c(.05),disabled:t||N>=1},"+")),d.createElement("button",{type:"button",className:`speaker-mute-chip ${L?"active":""}`,onClick:x,disabled:t},L?"MUTED":"MUTE"),d.createElement("div",{className:"speaker-volume-label"},"VOL ",h,"%"))}function fe(){let{state:e,holdScan:t,nextScan:a,avoidCurrent:n,syncFavoritesToProfile:M0,navigate:s}=P(),{hpState:i,liveStatus:r,working:u,error:f,message:w}=e,S=String(r?.stream_mount||"ANALOG.mp3").trim().replace(/^\//,""),L=String(r?.digital_stream_mount||"DIGITAL.mp3").trim().replace(/^\//,""),y=!!S,N=!!L,k=(e.mode==="hp"||e.mode==="expert")&&N?"digital":"analog",[h,g]=Y(k),[T,C]=Y(""),[c,o]=Y(!1),[m,b]=Y(""),[l,_]=Y(0);me(()=>{if(h==="digital"&&!N){g(y?"analog":"digital");return}h==="analog"&&!y&&N&&g("digital")},[y,N,h]),me(()=>{!f&&!w||b("")},[f,w]),me(()=>{let v=setInterval(()=>{_(W=>(W+1)%nt.length)},320);return()=>clearInterval(v)},[]),me(()=>{let v=W=>{let Tt=W?.detail&&typeof W.detail=="object"?W.detail:{},je=String(Tt.action||"").trim();if(!je)return;je==="set-source"&&typeof Tt.value=="string"&&(Tt.value==="analog"&&y?g("analog"):Tt.value==="digital"&&N&&g("digital")),je==="toggle-mute"?o(le=>!le):je==="set-mute"&&typeof Tt.value=="boolean"&&o(!!Tt.value)};return document.addEventListener(hp3AudioControlEvent,v),()=>document.removeEventListener(hp3AudioControlEvent,v)},[y,N]),me(()=>{document.dispatchEvent(new CustomEvent(hp3AudioStateEvent,{detail:{source:h,muted:c,analogAvailable:y,digitalAvailable:N}}))},[h,c,y,N]);let x=h==="digital"?L||S:S||L,E=h==="digital"&&N,V=String(i.mode||"full_database").trim().toLowerCase(),X=nt[l]||"|",ut=String(r?.profile_airband||"").trim(),mt=qt(r,"airband")||ut||"Analog",ft=r?.last_hit_airband_label||r?.last_hit_ground_label||r?.last_hit||"",Q=Yt(ft,mt),Le=E?r?.digital_scheduler_active_system_label||r?.digital_system_label||r?.digital_scheduler_active_system||i.system_name||i.system:Q.system,ne=E?r?.digital_department_label||r?.digital_scheduler_active_department_label||i.department_name||i.department||r?.digital_last_label:Q.department||i.department_name||i.department,Me=Vt(r?.digital_last_time),bt=Me>0?Math.max(0,Date.now()-Me):Number.POSITIVE_INFINITY,gt=!!(r?.digital_channel_label||r?.digital_last_label||r?.digital_last_tgid),Oe=E&&gt&&bt<=Gt,Pe=E&&Oe?r?.digital_last_tgid??i.tgid??i.talkgroup_id:"--",oe=E?(()=>{let v=Number(r?.digital_preflight?.playlist_frequency_hz?.[0]||r?.digital_playlist_frequency_hz?.[0]||0);return Number.isFinite(v)&&v>0?(v/1e6).toFixed(4):i.frequency??i.freq})():r?.last_hit_airband||r?.last_hit_ground||r?.last_hit||"--",De=!!(r?.digital_control_channel_metric_ready??r?.digital_control_decode_available),He=E?r?.digital_control_channel_locked?"Locked":De?"Decoding":i.signal??i.signal_strength:r?.rtl_active?"Active":"Idle",Fe=E?r?.digital_channel_label||r?.digital_last_label||i.channel_name||i.channel||ne:Q.channel||ne,se=E&&(r?.digital_last_mode||i.service_type||i.service)||"",ht=E?Fe:Q.channel||Fe,vt=E?[F(se||"Digital"),Pe!=="--"?`TGID ${F(Pe)}`:"",oe!=="--"?`${F(oe)} MHz`:"",He].filter(Boolean).join(" \u2022 "):`${F(oe)} \u2022 ${He}`,yt=E?r?.digital_control_channel_locked?4:De?3:1:r?.rtl_active?3:1,Be=String(r?.digital_scan_mode||"").toLowerCase()==="single_system",ze=Be?"HOLD":"SCAN",R=E&&ze==="SCAN"&&!Oe,$e=it(()=>{if(V!=="favorites")return"Full Database";let v=String(i.favorites_name||"").trim()||"My Favorites",W=Array.isArray(i.favorites)?i.favorites:[],Tt=v.toLowerCase(),je=W.find(le=>!le||typeof le!="object"?!1:String(le.label||"").trim().toLowerCase()===Tt);return(Array.isArray(je?.custom_favorites)?je.custom_favorites:Array.isArray(i.custom_favorites)?i.custom_favorites:[]).length===0?`${v} (empty)`:v},[V,i.custom_favorites,i.favorites,i.favorites_name]),syncState=r?.hp_favorites_sync&&typeof r.hp_favorites_sync=="object"?r.hp_favorites_sync:{},syncAvailable=!!(r?.hp_favorites_sync_available??syncState?.available),syncInSync=!!(r?.hp_favorites_sync_in_sync??syncState?.in_sync),syncMissing=Number(r?.hp_favorites_sync_missing_count??syncState?.missing_in_profile_count??0),syncExtra=Number(r?.hp_favorites_sync_extra_enabled_count??syncState?.extra_enabled_count??0),syncProfile=String(r?.hp_favorites_sync_profile_id||syncState?.active_profile_id||"").trim(),syncList=String(r?.hp_favorites_sync_favorites_name||syncState?.favorites_name||$e).trim(),syncReason=String(r?.hp_favorites_sync_reason||syncState?.reason||"").trim(),doSync=async()=>{try{let v=await M0(),W=v?.after&&typeof v.after=="object"?v.after:{},Tt=!!(v?.in_sync??W?.in_sync);if(Tt){b("Favorites and active SB3 profile are now synced.");return}let je=Number(W?.missing_in_profile_count||0),le=Number(W?.extra_enabled_count||0);b(`Sync applied. Drift remains (missing ${je}, extra ${le}).`)}catch{}},St=E?se?`Service: ${F(se)}`:"Service: Digital":V==="favorites"?`List: ${$e}`:"Full Database",Ue=R?`Scanning ${X}`:ne,_t=R?`Service: Digital ${X}`:St,Ge=R?`Scanning ${X}`:ht,Ve=R?`Digital \u2022 Awaiting activity ${X}`:vt,Nt=async()=>{try{await t()}catch{}},xt=async()=>{try{await a()}catch{}},Et=async()=>{try{await n()}catch{}},At=async(v,W)=>{if(v==="info"){b(W==="system"?`System: ${F(Le)}`:W==="department"?`Department: ${F(Ue)}`:`Channel: ${F(Ge)} (${F(Ve)})`),C("");return}if(v==="advanced"){b("Advanced options are still being wired in HP3."),C("");return}if(v==="prev"){b("Previous-channel stepping is not wired yet in HP3."),C("");return}if(v==="fave"){C(""),s(p.FAVORITES);return}if(!E){b("Switch Audio Source to Digital for HOLD/NEXT/AVOID controls."),C("");return}v==="hold"?await Nt():v==="next"?await xt():v==="avoid"&&await Et(),C("")},kt=it(()=>[{id:"squelch",label:"Squelch",onClick:()=>b("Squelch is currently managed from SB3 analog controls.")},{id:"range",label:Wt(i.range_miles),onClick:()=>s(p.RANGE)},{id:"atten",label:"Atten",onClick:()=>b("Attenuation toggle is not wired yet in HP3.")},{id:"gps",label:"GPS",onClick:()=>s(p.LOCATION)},{id:"help",label:"Help",onClick:()=>s(p.MENU)}],[i.range_miles,s]),wt={system:[{id:"info",label:"Info"},{id:"advanced",label:"Advanced"},{id:"prev",label:"Prev"},{id:"next",label:"Next"},{id:"avoid",label:"Avoid"}],department:[{id:"info",label:"Info"},{id:"advanced",label:"Advanced"},{id:"prev",label:"Prev"},{id:"next",label:"Next"},{id:"avoid",label:"Avoid"}],channel:[{id:"info",label:"Info"},{id:"advanced",label:"Advanced"},{id:"prev",label:"Prev"},{id:"hold",label:"Hold"},{id:"next",label:"Next"},{id:"avoid",label:"Avoid"},{id:"fave",label:"Fave"}]};return d.createElement("section",{className:"screen main-screen hp2-main"},d.createElement("div",{className:"hp2-radio-bar"},d.createElement("div",{className:"hp2-radio-buttons"},kt.map(v=>d.createElement("button",{key:v.id,type:"button",className:"hp2-radio-btn",onClick:v.onClick,disabled:u},v.label))),d.createElement("div",{className:"hp2-status-icons"},d.createElement("span",{className:`hp2-icon ${Be?"on":""}`},ze),d.createElement("span",{className:"hp2-icon"},"SIG ",jt(yt)),d.createElement("span",{className:"hp2-icon"},E?"DIG":"ANA"))),d.createElement("div",{className:"hp2-lines"},d.createElement("div",{className:"hp2-line"},d.createElement("div",{className:"hp2-line-label"},"System / Favorite List"),d.createElement("div",{className:"hp2-line-body"},d.createElement("div",{className:"hp2-line-primary"},F(Le)),d.createElement("div",{className:"hp2-line-secondary"},$e)),d.createElement("button",{type:"button",className:"hp2-subtab",onClick:()=>C(v=>v==="system"?"":"system"),disabled:u},"<")),d.createElement("div",{className:"hp2-line"},d.createElement("div",{className:"hp2-line-label"},"Department"),d.createElement("div",{className:"hp2-line-body"},d.createElement("div",{className:"hp2-line-primary"},F(Ue)),d.createElement("div",{className:"hp2-line-secondary"},_t)),d.createElement("button",{type:"button",className:"hp2-subtab",onClick:()=>C(v=>v==="department"?"":"department"),disabled:u},"<")),d.createElement("div",{className:"hp2-line channel"},d.createElement("div",{className:"hp2-line-label"},"Channel"),d.createElement("div",{className:"hp2-line-body"},d.createElement("div",{className:"hp2-line-primary"},F(Ge)),d.createElement("div",{className:"hp2-line-secondary"},F(Ve))),d.createElement("button",{type:"button",className:"hp2-subtab",onClick:()=>C(v=>v==="channel"?"":"channel"),disabled:u},"<"))),T?d.createElement("div",{className:"hp2-submenu-popup"},wt[T]?.map(v=>d.createElement("button",{key:v.id,type:"button",className:"hp2-submenu-btn",onClick:()=>At(v.id,T),disabled:u},v.label))):null,d.createElement("div",{className:"hp2-feature-bar"},d.createElement("button",{type:"button",className:"hp2-feature-btn",onClick:()=>s(p.MENU),disabled:u},"Menu"),d.createElement("button",{type:"button",className:"hp2-feature-btn",onClick:()=>b("Replay is not wired yet in HP3."),disabled:u},"Replay"),d.createElement("button",{type:"button",className:"hp2-feature-btn",onClick:()=>b("Recording controls are not wired yet in HP3."),disabled:u},"Record"),d.createElement("button",{type:"button",className:"hp2-feature-btn",onClick:()=>o(v=>!v),disabled:u},c?"Unmute":"Mute")),E&&syncAvailable?d.createElement("div",{className:`hp2-sync-row ${syncInSync?"ok":"warn"}`},d.createElement("div",{className:"hp2-sync-text"},d.createElement("div",{className:"hp2-sync-primary"},syncInSync?`SB3 Sync: OK (${syncList||"Favorites"} -> ${syncProfile||"active profile"})`:`SB3 Drift: missing ${syncMissing}, extra ${syncExtra}`),syncReason?d.createElement("div",{className:"hp2-sync-secondary"},syncReason):null),d.createElement(D,{variant:syncInSync?"secondary":"primary",onClick:doSync,disabled:u},"Sync SB3")):null,d.createElement("audio",{id:"hp3-hidden-audio",preload:"none",muted:c,className:"hp2-audio-player-hidden",src:x?`/stream/${x}`:"/stream/"}),m?d.createElement("div",{className:"message"},m):null,E?null:d.createElement("div",{className:"muted"},"HOLD/NEXT/AVOID actions require Digital source."),f?d.createElement("div",{className:"error"},f):null,w?d.createElement("div",{className:"message"},w):null)}import Z from
"https://esm.sh/react@18";import K from"https://esm.sh/react@18";function $({title:e,subtitle:t="",showBack:a=!1,onBack:n}){return K.createElement("div",{className:"header"},K.createElement("div",null,K.createElement("h1",null,e),t?K.createElement("div",{className:"sub"},t):null),a?K.createElement("button",{type:"button",className:"btn btn-secondary",onClick:n},"Back"):null)}var Kt=[{id:"location",label:"Set Your Location",icon:"LOC",target:p.LOCATION},{id:"display",label:"Display Options",icon:"DSP",target:p.RANGE},{id:"service",label:"Select Service Types",icon:"SRV",target:p.SERVICE_TYPES},{id:"owner",label:"Owner Information",icon:"OWN",message:"Owner Information is not wired yet in HP3."},{id:"audio",label:"Audio Options",icon:"AUD",target:p.AVOID},{id:"favorites",label:"Manage Favorites Lists",icon:"FAV",target:p.FAVORITES},{id:"weather",label:"Weather Mode",icon:"WX",message:"Weather Mode is not wired yet in HP3."},{id:"advanced",label:"Advanced Menu",icon:"ADV",message:"SB3 mode is always active. Use Favorites or Full Database to choose the DB source."}];function be(){let{navigate:e,state:t}=P(),[a,n]=Z.useState("");return Z.createElement("section",{className:"screen hp2-picker hp2-main-menu-screen"},Z.createElement("div",{className:"hp2-picker-top"},Z.createElement("div",{className:"hp2-picker-title"},"Main Menu"),Z.createElement("div",{className:"hp2-picker-top-right"},Z.createElement("span",{className:"hp2-picker-help"},"Help"),Z.createElement("span",{className:"hp2-picker-status"},"L"),Z.createElement("span",{className:"hp2-picker-status"},"SIG"),Z.createElement("span",{className:"hp2-picker-status"},"BAT"))),Z.createElement("div",{className:"hp2-main-menu-grid"},Kt.map(s=>Z.createElement("button",{key:s.id,type:"button",className:"hp2-main-menu-tile",onClick:()=>{s.target?e(s.target):n(s.message||"")},disabled:t.working},Z.createElement("span",{className:"hp2-main-menu-icon","aria-hidden":"true"},s.icon),Z.createElement("span",{className:"hp2-main-menu-label"},s.label)))),Z.createElement("div",{className:"hp2-main-menu-bottom"},Z.createElement("button",{type:"button",className:"hp2-picker-btn listen",onClick:()=>e(p.MAIN),disabled:t.working},"Listen"),Z.createElement("div",{className:"hp2-main-menu-bottom-fill","aria-hidden":"true"})),a?Z.createElement("div",{className:"message hp2-main-menu-message"},a):null,t.error?Z.createElement("div",{className:"error hp2-main-menu-message"},t.error):null)}import O,{useEffect as Zt,useState as J}from"https://esm.sh/react@18";
function ot(e){if(e===""||e===null||e===void 0)return null;let t=Number(e);return Number.isFinite(t)?t:NaN}
const HP3_AUTOLOCATE_TIMEOUT_MS=12000;
const HP3_IP_GEOLOOKUP_URL="/api/hp/location/ip";
function hp3DescribeGeoError(e){let t=Number(e&&e.code);return t===1?"Location permission denied.":t===2?"Current GPS location is unavailable.":t===3?"GPS location request timed out.":typeof window<"u"&&window.isSecureContext===!1?"GPS location requires HTTPS or localhost.":String(e&&e.message?e.message:"GPS location lookup failed.").trim()}
const HP3_REVERSE_GEOLOOKUP_URL="/api/hp/location/reverse";
function hp3ParseIpLocation(e){let t=e&&typeof e=="object"?e:{},a=Number("latitude"in t?t.latitude:t.lat),n=Number("longitude"in t?t.longitude:t.lon);if(!Number.isFinite(a)||!Number.isFinite(n)||a<-90||a>90||n<-180||n>180)throw new Error("IP location response did not include valid coordinates.");return{lat:a,lon:n,zip:String(t.postal||t.postcode||t.zip||"").trim(),county:String(t.county||"").trim()}}
function hp3FormatZipCountySummary(e,t){let a=[],n=String(e||"").trim(),s=String(t||"").trim();return n&&a.push(`ZIP ${n}`),s&&a.push(s),a.join(" \u2022 ")}
function hp3ParseReverseLocation(e){let t=e&&typeof e=="object"?e:{},a=String("postcode"in t?t.postcode:"postal_code"in t?t.postal_code:"postal"in t?t.postal:"zip"in t?t.zip:"").trim(),n=String(t.county||"").trim();if(!n){let i=Array.isArray(t?.localityInfo?.administrative)?t.localityInfo.administrative:[];for(let r=0;r<i.length;r+=1){let u=i[r]&&typeof i[r]=="object"?i[r]:{},f=String(u.name||"").trim(),w=String(u.description||"").toLowerCase();if(!f)continue;if(w.includes("county")||/ county$/i.test(f)){n=f;break}}}return{zip:a,county:n}}
async function hp3ResolveZipCounty(e,t){if(!Number.isFinite(Number(e))||!Number.isFinite(Number(t)))return{zip:"",county:""};let a=`${HP3_REVERSE_GEOLOOKUP_URL}?latitude=${encodeURIComponent(String(e))}&longitude=${encodeURIComponent(String(t))}&localityLanguage=en`,n=await fetch(a,{cache:"no-store"});if(!n.ok)throw new Error(`Reverse location lookup failed (HTTP ${n.status}).`);let s=await n.json();return hp3ParseReverseLocation(s)}
async function hp3ResolveCurrentLocation(){let e=null;if(typeof navigator<"u"&&navigator!=null&&navigator.geolocation&&typeof navigator.geolocation.getCurrentPosition=="function")try{let t=await new Promise((a,n)=>{navigator.geolocation.getCurrentPosition(a,n,{enableHighAccuracy:!0,timeout:HP3_AUTOLOCATE_TIMEOUT_MS,maximumAge:3e4})}),a=Number(t!=null&&t.coords?t.coords.latitude:void 0),n=Number(t!=null&&t.coords?t.coords.longitude:void 0);if(Number.isFinite(a)&&Number.isFinite(n)&&a>=-90&&a<=90&&n>=-180&&n<=180)return{lat:a,lon:n,source:"gps",fallbackReason:""};e=new Error("GPS returned invalid coordinates.")}catch(t){e=t}else e=new Error("GPS location is not available in this browser.");let t=hp3DescribeGeoError(e),a=await fetch(HP3_IP_GEOLOOKUP_URL,{cache:"no-store"});if(!a.ok)throw new Error(t+" IP fallback failed (HTTP "+a.status+").");let n=await a.json(),s=hp3ParseIpLocation(n);return{lat:s.lat,lon:s.lon,source:"ip",fallbackReason:t,zip:s.zip,county:s.county}}
function ge(){let{state:e,saveHpState:t,navigate:a}=P(),{hpState:n,working:s}=e,[i,r]=J(""),[u,f]=J(""),[w,S]=J(""),[L,y]=J(!0),[N,k]=J(""),[oe,ae]=J(""),[re,se]=J(!1),[ce,le]=J("");Zt(()=>{r(n.zip||n.postal_code||""),f(n.lat!==void 0&&n.lat!==null?String(n.lat):n.latitude!==void 0&&n.latitude!==null?String(n.latitude):""),S(n.lon!==void 0&&n.lon!==null?String(n.lon):n.longitude!==void 0&&n.longitude!==null?String(n.longitude):""),y(n.use_location!==!1),le("")},[n]);let saveLocation=async()=>{if(k(""),ae(""),le(""),i&&!/^\d{5}(-\d{4})?$/.test(i)){k("ZIP must be 5 digits or ZIP+4.");return}let g=ot(u),T=ot(w);if(Number.isNaN(g)||Number.isNaN(T)){k("Latitude and longitude must be valid numbers.");return}if((g===null)!==(T===null)){k("Enter both latitude and longitude, or leave both blank.");return}if(g!==null&&(g<-90||g>90)){k("Latitude must be between -90 and 90.");return}if(T!==null&&(T<-180||T>180)){k("Longitude must be between -180 and 180.");return}try{let C={zip:i,use_location:L};g!==null&&T!==null?(C.lat=g,C.lon=T):i&&L&&(C.resolve_zip=!0),await t(C),a(p.MENU)}catch{}},autoLocate=async()=>{if(re||s)return;k(""),ae(""),le(""),se(!0);try{let g=await hp3ResolveCurrentLocation(),T={zip:String(g.zip||"").trim(),county:String(g.county||"").trim()};try{let c=await hp3ResolveZipCounty(g.lat,g.lon);T={zip:String(c.zip||T.zip||"").trim(),county:String(c.county||T.county||"").trim()}}catch{}let C=String(T.zip||i||"").trim(),c=hp3FormatZipCountySummary(C,T.county),o=String(g.fallbackReason||"").trim();f(String(g.lat)),S(String(g.lon)),r(C),y(!0),le(c?`Auto-locate populated ${c}.`:""),await t({zip:C,use_location:!0,lat:g.lat,lon:g.lon}),g.source==="ip"?ae(`GPS unavailable, used IP location.${c?` ${c}.`:""}${o?` ${o}`:""}`):ae(`GPS location applied.${c?` ${c}.`:""}`)}catch(g){k(String(g!=null&&g.message?g.message:"Unable to detect current location."))}finally{se(!1)}};return O.createElement("section",{className:"screen location-screen"},O.createElement($,{title:"Location",showBack:!0,onBack:()=>a(p.MENU)}),O.createElement("div",{className:"list"},O.createElement("label",null,O.createElement("div",{className:"muted"},"ZIP"),O.createElement("input",{className:"input",value:i,onChange:g=>r(g.target.value.trim()),placeholder:"37201"})),O.createElement("label",null,O.createElement("div",{className:"muted"},"Latitude"),O.createElement("input",{className:"input",value:u,onChange:g=>f(g.target.value),placeholder:"36.12"})),O.createElement("label",null,O.createElement("div",{className:"muted"},"Longitude"),O.createElement("input",{className:"input",value:w,onChange:g=>S(g.target.value),placeholder:"-86.67"})),O.createElement("label",{className:"row"},O.createElement("span",null,"Use location for scanning"),O.createElement("input",{type:"checkbox",checked:L,onChange:g=>y(g.target.checked)}))),ce?O.createElement("div",{className:"muted location-meta"},ce):null,O.createElement("div",{className:"button-row"},O.createElement(D,{onClick:saveLocation,disabled:s||re},"Save")),O.createElement("div",{className:"button-row location-action-row"},O.createElement(D,{onClick:autoLocate,disabled:s||re,variant:"secondary",className:"location-autolocate-btn"},re?"Locating...":"Use Current Location")),oe?O.createElement("div",{className:"message"},oe):null,N?O.createElement("div",{className:"error"},N):null,e.error?O.createElement("div",{className:"error"},e.error):null)}
import I,{useEffect as st,useMemo as he,useState as te}from"https://esm.sh/react@18";var ve=8,Jt=8;function lt(e){let t=Number(e);return Number.isFinite(t)?t:0}function ye(){let{state:e,saveHpState:t,navigate:a}=P(),{hpState:n,serviceTypes:s,working:i}=e,r=he(()=>s.filter(o=>o.enabled_by_default).map(o=>Number(o.service_tag)),[s]),u=he(()=>[...s].sort((o,m)=>{let b=lt(o.service_tag),l=lt(m.service_tag);return b!==l?b-l:String(o.name||"").localeCompare(String(m.name||""))}),[s]),[f,w]=te([]),[S,L]=te(0),[y,N]=te(""),[k,h]=te("");st(()=>{let o=Array.isArray(n.enabled_service_tags)?n.enabled_service_tags.map(Number):r;w(Array.from(new Set(o)).filter(m=>Number.isFinite(m)&&m>0))},[n.enabled_service_tags,r]);let g=Math.max(1,Math.ceil(u.length/ve));st(()=>{S>=g&&L(Math.max(0,g-1))},[S,g]);let T=he(()=>{let o=S*ve,b=[...u.slice(o,o+ve)];for(;b.length<Jt;)b.push(null);return b},[u,S]),C=o=>{h(""),N(""),w(m=>m.includes(o)?m.filter(b=>b!==o):[...m,o])},c=async o=>{h(""),N("");try{await t({enabled_service_tags:[...f].sort((m,b)=>m-b)}),typeof o=="function"?o():N("Service types saved.")}catch(m){h(m?.message||"Failed to save service types.")}};return I.createElement("section",{className:"screen hp2-picker service-types-screen"},I.createElement("div",{className:"hp2-picker-top"},I.createElement("div",{className:"hp2-picker-title"},"Select Service Types"),I.createElement("div",{className:"hp2-picker-top-right"},I.createElement("span",{className:"hp2-picker-help"},"Help"),I.createElement("span",{className:"hp2-picker-status"},"L"),I.createElement("span",{className:"hp2-picker-status"},"SIG"),I.createElement("span",{className:"hp2-picker-status"},"BAT"))),I.createElement("div",{className:"hp2-picker-grid"},T.map((o,m)=>{if(!o)return I.createElement("div",{key:`empty-${m}`,className:"hp2-picker-tile hp2-picker-tile-empty"});let b=Number(o.service_tag),l=f.includes(b);return I.createElement("button",{key:`${b}-${o.name}`,type:"button",className:`hp2-picker-tile ${l?"active":""}`,onClick:()=>C(b),disabled:i},o.name)})),I.createElement("div",{className:"hp2-picker-bottom hp2-picker-bottom-5"},I.createElement("button",{type:"button",className:"hp2-picker-btn listen",onClick:()=>c(()=>a(p.MAIN)),disabled:i},"Listen"),I.createElement("button",{type:"button",className:"hp2-picker-btn",onClick:()=>a(p.MENU),disabled:i},"Back"),I.createElement("button",{type:"button",className:"hp2-picker-btn",onClick:()=>c(()=>a(p.MENU)),disabled:i},"Accept"),I.createElement("button",{type:"button",className:"hp2-picker-btn",onClick:()=>L(o=>Math.max(0,o-1)),disabled:i||S<=0},"^"),I.createElement("button",{type:"button",className:"hp2-picker-btn",onClick:()=>L(o=>Math.min(g-1,o+1)),disabled:i||S>=g-1},"v")),I.createElement("div",{className:"muted hp2-picker-page"},"Page ",S+1," / ",g),y?I.createElement("div",{className:"message"},y):null,k?I.createElement("div",{className:"error"},k):null,e.error?I.createElement("div",{className:"error"},e.error):null)}import U,{useEffect as Xt,useState as Qt}from"https://esm.sh/react@18";function Se(){let{state:e,saveHpState:t,navigate:a}=P(),{hpState:n,working:s}=e,[i,r]=Qt(15);Xt(()=>{let f=Number(n.range_miles);r(Number.isFinite(f)?f:15)},[n.range_miles]);let u=async()=>{try{await t({range_miles:i}),a(p.MENU)}catch{}};return U.createElement("section",{className:"screen range-screen"},U.createElement($,{title:"Range",showBack:!0,onBack:()=>a(p.MENU)}),U.createElement("div",{className:"card"},U.createElement("div",{className:"row"},U.createElement("span",null,"Range Miles"),U.createElement("strong",null,i.toFixed(1))),U.createElement("input",{className:"range",type:"range",min:"0",max:"30",step:"0.5",value:i,onChange:f=>r(Number(f.target.value))})),U.createElement("div",{className:"button-row"},U.createElement(D,{onClick:u,disabled:s},"Save")),e.error?U.createElement("div",{className:"error"},e.error):null)}import M,{useEffect as dt,useMemo as _e,useState as ae}from"https://esm.sh/react@18";
...
function Ee(){
  ...
  let favItemsForView=_e(()=>{if(N==="manage")return St;if(N==="review")return Ue;if(N==="country")return m;if(N==="state")return l;if(N==="county")return x;if(N==="scope")return Rt;if(N==="system")return V;if(N==="department")return Le.map(d=>({id:`dept:${d}`,name:d,label:d}));if(N==="channel")return _t;return[]},[N,St,Ue,m,l,x,Rt,V,Le,_t]),favPageCount=Math.max(1,Math.ceil(favItemsForView.length/re));
  ...
  let favLoadCountries=async()=>{o(!0),y(""),S("");try{let d=await favWizardFetch("/api/hp/favorites-wizard/countries"),v=Array.isArray(d?.countries)?d.countries:[];b(v);let W=Number(v[0]?.country_id||1)||1;bt(W),_([]),E([]),X([]),mt([]),Q([]),ne([]),Oe(0),oe(0),Qt("county"),se(null),vt(""),k("country")}catch(d){y(d?.message||"Failed to load countries.")}finally{o(!1)}};
  let favLoadStates=async d=>{let v=Number(d||0);if(!v)return;o(!0),y(""),S("");try{let W=await favWizardFetch("/api/hp/favorites-wizard/states",{country_id:v}),Tt=Array.isArray(W?.states)?W.states:[];_(Tt),Oe(Number(Tt[0]?.state_id||0)||0),E([]),X([]),mt([]),Q([]),ne([]),oe(0),Qt("county"),se(null),vt(""),k("state")}catch(W){y(W?.message||"Failed to load states.")}finally{o(!1)}};
  let favLoadCounties=async d=>{let v=Number(d||0);if(!v)return;o(!0),y(""),S("");try{let W=await favWizardFetch("/api/hp/favorites-wizard/counties",{state_id:v}),Tt=Array.isArray(W?.counties)?W.counties:[];E(Tt),oe(Number(Tt[0]?.county_id||0)||0),Qt("county"),X([]),mt([]),Q([]),ne([]),se(null),vt(""),k("county")}catch(W){y(W?.message||"Failed to load counties.")}finally{o(!1)}};
  let favLoadSystems=async(d,v,W,Tt=Jt)=>{let je=Number(d||0),le=Number(v||0),ot=String(W||"digital").toLowerCase()==="analog"?"analog":"digital",Z=String(Tt||"county").toLowerCase();Z!=="nationwide"&&Z!=="statewide"&&Z!=="county"&&(Z="county");if(!je)return;o(!0),y(""),S("");try{let J=await favWizardFetch("/api/hp/favorites-wizard/systems",{state_id:je,county_id:le,system_type:ot,scope:Z}),K=Array.isArray(J?.systems)?J.systems:[];X(K),Qt(Z),se(null),mt([]),Q([]),ne([]),vt(""),k("system")}catch(J){y(J?.message||"Failed to load systems.")}finally{o(!1)}};
...
import A,{useEffect as ra,useMemo as pt,useState as ia}from"https://esm.sh/react@18";function na(e){return Array.isArray(e)?e.map((t,a)=>t&&typeof t=="object"?{id:String(t.id??`${t.type||"item"}-${a}`),label:String(t.label||t.alpha_tag||t.name||`Avoid ${a+1}`),type:String(t.type||"item"),source:"persistent"}:{id:`item-${a}`,label:String(t),type:"item",source:"persistent"}):[]}function oa(e){if(!Array.isArray(e))return[];let t=[],a=new Set;return e.forEach(n=>{let s=String(n||"").trim();!s||a.has(s)||(a.add(s),t.push({id:`runtime:${s}`,label:s,type:"system",token:s,source:"runtime"}))}),t}function Ae(){let{state:e,saveHpState:t,avoidCurrent:a,clearHpAvoids:n,removeHpAvoid:s,navigate:i}=P(),{hpState:r,hpAvoids:u,working:f}=e,w=pt(()=>Array.isArray(r.avoid_list)?r.avoid_list:Array.isArray(r.avoids)?r.avoids:Array.isArray(r.avoid)?r.avoid:[],[r.avoid_list,r.avoids,r.avoid]),[S,L]=ia([]);ra(()=>{L(na(w))},[w]);let y=pt(()=>oa(u),[u]),N=async(h=S)=>{try{await t({avoid_list:h})}catch{}},k=async()=>{try{await a()}catch{}};return A.createElement("section",{className:"screen avoid-screen"},A.createElement($,{title:"Avoid",showBack:!0,onBack:()=>i(p.MENU)}),A.createElement("div",{className:"list"},A.createElement("div",{className:"card"},A.createElement("div",{className:"muted",style:{marginBottom:"8px"}},"Runtime Avoids (HP Scan Pool)"),y.length===0?A.createElement("div",{className:"muted"},"No runtime HP avoids."):y.map(h=>A.createElement("div",{key:h.id,className:"row",style:{marginBottom:"6px"}},A.createElement("div",null,A.createElement("div",null,h.label),A.createElement("div",{className:"muted"},h.type)),A.createElement(D,{variant:"danger",onClick:()=>s(h.token),disabled:f},"Remove")))),A.createElement("div",{className:"card"},A.createElement("div",{className:"muted",style:{marginBottom:"8px"}},"Persistent Avoids (State)"),S.length===0?A.createElement("div",{className:"muted"},"No persistent avoids in current state."):S.map(h=>A.createElement("div",{key:h.id,className:"row",style:{marginBottom:"6px"}},A.createElement("div",null,A.createElement("div",null,h.label),A.createElement("div",{className:"muted"},h.type)),A.createElement(D,{variant:"danger",onClick:()=>{let g=S.filter(T=>T.id!==h.id);L(g),N(g)},disabled:f},"Remove"))))),A.createElement("div",{className:"button-row"},A.createElement(D,{onClick:k,disabled:f},"Avoid Current"),A.createElement(D,{variant:"secondary",onClick:async()=>{L([]),await N([]),await n()},disabled:f},"Clear All"),A.createElement(D,{onClick:()=>N(),disabled:f},"Save")),e.error?A.createElement("div",{className:"error"},e.error):null)}import B,{useEffect as sa,useState as la}from"https://esm.sh/react@18";function ke(){let{state:e,navigate:t}=P();return B.createElement("section",{className:"screen mode-selection-screen"},B.createElement($,{title:"Scan Source",showBack:!0,onBack:()=>t(p.MENU)}),B.createElement("div",{className:"list"},B.createElement("div",{className:"card"},B.createElement("div",null,"SB3 mode is always active."),B.createElement("div",{className:"muted"},"Use Favorites or Full Database in the favorites screen to choose the database source."))),e.error?B.createElement("div",{className:"error"},e.error):null)}import da from"https://esm.sh/react@18";function we({label:e="Loading..."}){return da.createElement("div",{className:"loading"},e)}function Te(){let{state:e}=P();if(e.loading)return G.createElement(we,{label:"Loading HomePatrol state..."});switch(e.currentScreen){case p.MENU:return G.createElement(be,null);case p.LOCATION:return G.createElement(ge,null);case p.SERVICE_TYPES:return G.createElement(ye,null);case p.RANGE:return G.createElement(Se,null);case p.FAVORITES:return G.createElement(Ee,null);case p.AVOID:return G.createElement(Ae,null);case p.MODE_SELECTION:return G.createElement(ke,null);case p.MAIN:default:return G.createElement(fe,null)}}var pa=`
  * { box-sizing: border-box; }
  ...
  .speaker-vol-btn,
  .speaker-mute-chip {
    border: 1px solid #65564b;
    border-radius: 7px;
    background: rgba(16, 14, 14, 0.66);
    color: #eee6d3;
    font-size: 0.57rem;
    line-height: 1;
    font-weight: 700;
  ...
  .speaker-chip.active,
  .speaker-mute-chip.active {
    border-color: #efb55e;
    color: #ffd78b;
    background: rgba(63, 42, 26, 0.82);
  }
  .speaker-chip:disabled,
  .speaker-vol-btn:disabled,
  .speaker-mute-chip:disabled,
  .speaker-play-btn:disabled {
    opacity: 0.45;
    cursor: not-allowed;
  }
  .speaker-play-btn {
    ...
    height: 52px;
    border-radius: 999px;
    background: radial-gradient(circle at 30% 30%, #2f2824 0%, #1a1614 80%);
    color: #ffe0a3;
    font-size: 1rem;
    font-weight: 700;
  ...
  .speaker-vol-bar {
    ...
    height: 3px;
    border-radius: 2px;
    background: rgba(186, 177, 167, 0.45);
    cursor: pointer;
  }
  .speaker-vol-bar:disabled {
    cursor: not-allowed;
    opacity: 0.6;
  }
  .speaker-vol-bar.on {
    background: #ffcc6f;
    box-shadow: 0 0 6px rgba(255, 202, 107, 0.5);
  }
  ...
  .hp2-main-menu-grid {
    ...
    flex: 1;
    min-height: 0;
    background: linear-gradient(180deg, #101622 0%, #0b1018 100%);
  }
  .hp2-main-menu-tile {
    border: 1px solid #47566d;
    border-radius: 7px;
    background: linear-gradient(180deg, #45566b 0%, #2f3b4c 44%, #273243 100%);
    color: #e9f1ff;
    display: grid;
  ...
  .hp2-main-menu-bottom .hp2-picker-btn {
    border: 0;
    border-radius: 0;
    min-height: 46px;
    background: #1a2432;
  }
  .hp2-main-menu-bottom-fill {
    background: #141c29;
  }
  .hp2-main-menu-message {
    margin: 0;
      ...
      ie.createElement(
        ...
        ie.createElement(
          ...
          ie.createElement(
            ...
            ie.createElement(SpeakerAudioDock,null),
